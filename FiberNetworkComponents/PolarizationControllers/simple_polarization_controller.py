...
class SimplePolarizationController(AbstractPolarizationController):
    ...
    def setup_mueller_matrix(self):
        ...
        r_vec = normalize([s1 + s2 * s3 / normalization + z1, s2 - s1 * s3 / normalization + z2, 0])
        cos_2t, sin_2t, _ = r_vec
        ...
        self.mueller_matrix = hwp_stokes_matrix @ qwp_stokes_matrix
    ...
    def instrument_name(self):
        return "Simple Polarization Controller"
